...
### Шаг 5.3. Скачивание файла варианта на ПК (Download)

Скачаем файл варианта из папки `letunov` в текущую папку на локальном ПК:
...
<img width="1279" height="1023" alt="SCP загрузка" src="img/9.png" />
